<%@ Page Language="C#" MasterPageFile="~/SIMP.master"  AutoEventWireup="true" CodeBehind="Prices.aspx.cs" Inherits="website.Prices" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
   ...
   <asp:Label ID="Label1" runat="server" Font-Names="Ariel" Font-Size="24pt" ForeColor="Red" Text="Цени и услуги" CssClass="auto-style9"></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Hospital1ConnectionString %>"
        SelectCommand="SELECT [Price_NZOK], [Price_private] FROM [Price] WHERE ([Code_test] = @Code_test)" OnSelecting="SqlDataSource2_Selecting">
        <SelectParameters>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
        ...
        Font-Size="12pt" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" EnableSortingAndPagingCallbacks="True" >
